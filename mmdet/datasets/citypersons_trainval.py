...
class CityPersonsTrainValDataset(CustomDataset):
    ...
    def load_annotations(self, ann_files):
        ann_files = [ann_files + 'anno_train.mat', ann_files + 'anno_val.mat'] 
        self.cat_ids = [1]
        self.img_ids = list()
        self.annos = list()
        ...
        for ann_file in ann_files:
            ...
            for i, each_anno in enumerate(anno):
                ...
                if len(ann_info['labels']) != 0:
                    self.ids_with_ann.append(cur_id)
    ...
    def _parse_ann_info(self, ann_info, with_mask=False):
        ...
        for bb in ann_list:
            ...
            if lb == 1 and h>=50 and vis_ratio>=0.45:
