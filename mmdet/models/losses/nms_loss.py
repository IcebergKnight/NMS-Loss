...
class NMSLoss(nn.Module):
    ...
    def __init__(self, reduction='none', loss_weight=1.0, use_score = True, add_gt = False, pull_relax = True, push_relax = False, push_select = True, fix_pushs_grad = False, fix_reg_gradient=False, fix_pull_reg=False, pull_weight = 1, push_weight = 1, nms_thr = 0.5):
