...
class MaskAttentionFPNConv(nn.Module):
    ...
    def __init__(self,
                 ...
                 output_indices=None):
        super(MaskAttentionFPNConv, self).__init__()
        ...
        assert len(additional_fpn_conv) == num_outs
        ...
        for conv_num in additional_fpn_conv:
            self.additional_conv.append(
                nn.Sequential(
                    *[ConvModule(
                        out_channels,
                        out_channels,
    ...
    def forward(self, inputs):
        ...
        for i in range(len(outs)):
            outs[i] = self.additional_conv[i](outs[i])
