...
class RPN_TAGHead3(AnchorHead):

    def __init__(self, in_channels, tag_anchor_free = False, **kwargs):
        self.tag_anchor_free = tag_anchor_free
        super(RPN_TAGHead3, self).__init__(2, in_channels, **kwargs)
