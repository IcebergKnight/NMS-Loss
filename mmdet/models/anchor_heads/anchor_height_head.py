...
from mmdet.core import (AnchorGenerator, anchor_target, delta2bbox_nowidth,
...
class AnchorHeightHead(nn.Module):
    ...
    def __init__(self,
        ...
        super(AnchorHeightHead, self).__init__()
    ...
    def _init_layers(self):
        ...
        self.conv_reg = nn.Conv2d(self.feat_channels, self.num_anchors * 3, 1)
    ...
    def loss_single(self, cls_score, bbox_pred, labels, label_weights,
        ...
        bbox_pred = bbox_pred.permute(0, 2, 3, 1).reshape(-1, 3)
        no_width_bbox_targets = bbox_targets[:,[0,1,3]]
        no_width_bbox_weights = bbox_weights[:,[0,1,3]]
        loss_bbox = self.loss_bbox(
            bbox_pred,
            no_width_bbox_targets,
            no_width_bbox_weights,
    ...
    def loss(self,
        ...
        (labels_list, label_weights_list, bbox_targets_list, bbox_weights_list,
         num_total_pos, num_total_neg, all_bbox_gt_inds) = cls_reg_targets
        num_total_samples = (
    ...
    def get_bboxes_single(self,
        ...
        for cls_score, bbox_pred, anchors in zip(cls_scores, bbox_preds,
            ...
            bbox_pred = bbox_pred.permute(1, 2, 0).reshape(-1, 3)
            ...
            bboxes = delta2bbox_nowidth(anchors, bbox_pred, self.height_width_ratio, self.target_means, self.target_stds, img_shape)
